                        ...
                        <?php $menuSelected = get_theme_mod('tesseract_header_menu_select');
							...
							if ( $menuSelected !== 'none' ) : ?>
                                ...
                                <nav id="site-navigation" class="<?php echo $mmdClass; ?> main-navigation top-navigation <?php echo $hmenusize_class; ?>" role="navigation">
                                  <ul id="menu-test-menu-1" class="nav-menu">
                                  <li id="menu-item-home" class="menu-item-home">
                                  <a href="http://localhost/wordpress/">Home</a></li>
                                  <li id="menu-item-about" class="menu-item-about">
                                  <a href="http://localhost/wordpress/index.php/about/">About</a></li>
                                  <li id="menu-item-set-list" class="menu-item-set-list">
                                  <a href="http://localhost/wordpress/index.php/set-list/">Set List</a></li>
                                  <li id="menu-item-media" class="menu-item-media">
                                  <a href="http://localhost/wordpress/index.php/media/">Media</a></li>
                                  <li id="menu-item-contact" class="menu-item-contact">
                                  <a href="http://localhost/wordpress/index.php/contact/">Contact</a></li></ul>                                
                                </nav><!-- #site-navigation -->
